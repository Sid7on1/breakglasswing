import { parseTreeNodes, textByElementIndex, foldTreeTextIntoElements } from '../computer/tree.text';
import { rankSemanticTargets } from '../computer/semantic.targeting';
import { accessibilityEventInvalidatesObservation } from '../computer/desktop.runtime';
