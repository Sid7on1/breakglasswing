...
import { rankSemanticTargets } from '../src/computer/semantic.targeting';
import { diffVisualFingerprints, parseVisualFingerprint } from '../src/computer/visual.fingerprint';
